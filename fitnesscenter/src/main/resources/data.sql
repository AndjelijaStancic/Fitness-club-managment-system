...
INSERT INTO TRENER(korisnicko_ime, ime, prezime, sifra, email, datum_rodjenja, telefon, aktivan, prosecna_ocena, fitness_centar_id) VALUES ('predrag1', 'Predrag', 'Stankovic', '1234', 'frenki@gmail.com', '1998-05-20', '0644222211', '1','2.4',1);
INSERT INTO TRENER(korisnicko_ime, ime, prezime, sifra, email, datum_rodjenja, telefon, aktivan, prosecna_ocena, fitness_centar_id) VALUES ('BaneeeX', 'Vukan', 'Petrovic', 'ahsjfas', 'vukan@gmail.com', '2000-03-29', '0641622211', '1', '5.9', 1);
INSERT INTO TRENER(korisnicko_ime, ime, prezime, sifra, email, datum_rodjenja, telefon, aktivan, prosecna_ocena, fitness_centar_id) VALUES ('kata', 'Katarina', 'Milenkovic', 'ajskdf', 'kata@gmail.com', '2004-04-30', '064423451', '1', '2.9', 2);
INSERT INTO TRENER(korisnicko_ime, ime, prezime, sifra, email, datum_rodjenja, telefon, aktivan, prosecna_ocena, fitness_centar_id) VALUES ('isi1', 'Isidora', 'Petrovic', 'akshsjhd', 'isidora@gmail.com', '2003-12-31', '06543456', '1', '4.8', 1);
...
INSERT INTO TRENING(naziv, tip_treninga, opis) VALUES ('KONDICIJA', 'grupni', 'kondicioni');
INSERT INTO TRENING(naziv, tip_treninga, opis) VALUES ('SNAGA', 'individualni', 'dizanje tegova');
INSERT INTO TRENING(naziv, tip_treninga, opis) VALUES ('JOGA', 'grupni', 'meditiranje');
INSERT INTO TRENING(naziv, tip_treninga, opis) VALUES ('AEROBIK', 'grupni', 'skakanje');
...
INSERT INTO TERMIN(pocetak_termina, kraj_termina, trajanje_termina, cena_termina, trening_id, trener_id, sala_id) VALUES ('2021-11-06 09:15:00', '2021-11-06 11:15:00', '120', '1050', 3, 3,2);
INSERT INTO TERMIN(pocetak_termina, kraj_termina, trajanje_termina, cena_termina, trening_id, trener_id, sala_id) VALUES ('2021-11-07 18:30:00', '2021-11-07 19:30:00', '60', '500', 1, 4,4);
INSERT INTO TERMIN(pocetak_termina, kraj_termina, trajanje_termina, cena_termina, trening_id, trener_id, sala_id) VALUES ('2021-11-08 13:45:00', '2021-11-08 15:15:00', '90', '700', 2, 3,1);
INSERT INTO TERMIN(pocetak_termina, kraj_termina, trajanje_termina, cena_termina, trening_id, trener_id, sala_id) VALUES ('2021-11-08 12:30:00', '2021-10-08 14:00:00', '90', '700', 2, 3,1);
